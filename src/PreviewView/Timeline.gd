...
var dialogue_left_scene = preload(
	"res://src/ToolBox/PreviewView/PreviewDialogue/PreviewDialogueLeft.tscn"
)
var dialogue_right_scene = preload(
	"res://src/ToolBox/PreviewView/PreviewDialogue/PreviewDialogueRight.tscn"
)
...
# @returns {bool}
func _is_operator_matching(condition_operator: String, form_value, condition_value) -> bool:
