...
var timeline_field_boolean_scene := preload("res://src/Preview/Form/TimelineFieldBoolean.tscn")
var timeline_field_input_scene := preload("res://src/Preview/Form/TimelineFieldInput.tscn")
var conditions := {}
